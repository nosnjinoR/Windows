...
typedef int ref_init_db_fn(struct ref_store *refs, int flags,
			   struct strbuf *err);
...
ref_iterator_begin_fn(struct ref_store *ref_store, const char *prefix,
 ...
 */
typedef int read_symbolic_ref_fn(struct ref_store *ref_store,
