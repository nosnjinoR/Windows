 ...
 */
#define TEST(t, ...)                                                   \
	test__run_end(test__run_begin() ? 0 : (t, 1), TEST_LOCATION(), \
		      __VA_ARGS__)
...
#define check(x) check_bool_loc(TEST_LOCATION(), #x, x)
...
#define check_int(a, op, b)                                              \
	(test__tmp[0].i = (a), test__tmp[1].i = (b),                     \
	 check_int_loc(TEST_LOCATION(), #a " " #op " " #b,               \
		       test__tmp[0].i op test__tmp[1].i, test__tmp[0].i, \
		       test__tmp[1].i))
int check_int_loc(const char *loc, const char *check, int ok, intmax_t a,
		  intmax_t b);
...
#define check_uint(a, op, b)                                              \
	(test__tmp[0].u = (a), test__tmp[1].u = (b),                      \
	 check_uint_loc(TEST_LOCATION(), #a " " #op " " #b,               \
			test__tmp[0].u op test__tmp[1].u, test__tmp[0].u, \
			test__tmp[1].u))
int check_uint_loc(const char *loc, const char *check, int ok, uintmax_t a,
		   uintmax_t b);
...
#define check_char(a, op, b)                                              \
	(test__tmp[0].c = (a), test__tmp[1].c = (b),                      \
	 check_char_loc(TEST_LOCATION(), #a " " #op " " #b,               \
			test__tmp[0].c op test__tmp[1].c, test__tmp[0].c, \
			test__tmp[1].c))
...
int check_str_loc(const char *loc, const char *check, const char *a,
		  const char *b);
...
__attribute__((format(printf, 3, 4))) int test__run_end(int, const char *,
							const char *, ...);
